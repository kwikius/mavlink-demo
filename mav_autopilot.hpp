#ifndef MAVLINK_DEMO_MAVLINK_MAV_AUTOPILOT_HPP_INCLUDED
#define MAVLINK_DEMO_MAVLINK_MAV_AUTOPILOT_HPP_INCLUDED
...
#endif // MAVLINK_DEMO_MAVLINK_MAV_AUTOPILOT_HPP_INCLUDED
